 ...
 * License:       GPL-2.0+
 * License URI:   http://www.gnu.org/licenses/gpl-2.0.textdomain
 */
 ...
 class Hide_Default_Posts {
      ...
      public function __construct() {
        ...
        add_action( 'admin_menu', array( $this, 'remove_menus' ) );
          add_action( 'admin_bar_menu', array( $this, 'remove_admin_menu_items' ), 999 );
  ...
  public function remove_menus() {
    ...
    public function redirect_from_default_post_index() {
      if ( get_current_screen()->post_typ == 'post' ) {
