...
get_header(); ?>
	...
	<div id="primary-resources" class="resources-content-area">
      ...
      <div class="vatjss-mobile-resource-toggle-container">
        <div class="housing-toggle resource-toggle-mobile"><h3>Housing Resources</h3></div>
        <div class="justice-toggle resource-toggle-mobile"><h3>Justice Resources</h3></div>
        <div class="community-toggle resource-toggle-mobile"><h3>Community Resources</h3></div>
      </div>
