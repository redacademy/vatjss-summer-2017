...
function vatjss_scripts() {
	...
	wp_enqueue_script( 'vatjss-flickity', get_template_directory_uri() . '/js/lib/flickity.min.js', array( 'jquery' ), '20130115', true );
	wp_enqueue_script( 'vatjss-vatjss-carousel', get_template_directory_uri() . '/build/js/vatjss-carousel.min.js', array( 'jquery', 'vatjss-flickity' ), '20130115', true );
